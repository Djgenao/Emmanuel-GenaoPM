...
int main(void)
{
    ...
    printf("\nFrecuencia de Calificaciones\n");
    Impresion(FRE, 6); /* Se llama a la función Impresion para imprimir el arreglo de frecuencias. */

    Mayor(FRE, 6); /* Se llama a la función Mayor para obtener la frecuencia más alta. */
...
/* Esta función calcula la frecuencia de calificaciones. */
{
    ...
    for (I = 0; I < P; I++)
    {
        ...
        {
            B[A[I]]++; /* Almacena e incrementa las frecuencias. */
        }
    }
}
